...
copies of project files using
[`osf_download()`](https://docs.ropensci.org/osfr/reference/osf_download.md).
Or, if you come across a publication that directly references a file’s
OSF URL, you could quickly download it to your project directory by
providing the URL or simply the GUID:
...
![Screenshot of the uploaded file on
OSF](reference/figures/screen-shot.png)
